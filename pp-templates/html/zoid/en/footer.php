<div id="zen_footer" class="zen_fonts zen_tiny zen_gray zen_shadow_light zen_edit_area" contenteditable="false">
    <p>Copyright &copy; <?php echo date('Y'); ?>, <a href="%pp_company_url%">%pp_company%</a>.<br />Powered by <a href="http://www.zenbership.com/" target="_blank">Zenbership Membership Software</a>.</p>
</div>
