...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_products` (
  ...
  `tagline` varchar(255),
  `description` text,
  `type` tinyint(1) COMMENT '1 = one time, 2 = subscription, 3 = trial',
