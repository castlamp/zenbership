...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_calendars` (
  ...
  `members_only` tinyint(1),
  `owner` mediumint(6),
  `public` tinyint(1),
  `created` datetime DEFAULT '0000-00-00 00:00:00',
  `style` tinyint(1) COMMENT '1 = Calendar, 2 = Long List, 3 = Cloud',
  PRIMARY KEY  (`id`,`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8";
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_campaigns` (
  ...
  `owner` mediumint(5),
  `public` tinyint(1),
  `status` tinyint(1) COMMENT '1 = Active, 2 = Paused',
  `update_activity` tinyint(1),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_campaign_items` (
  ...
  `when_date` datetime DEFAULT '0000-00-00 00:00:00',
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_campaign_subscriptions` (
  ...
  `active` tinyint(1),
  `optin_id` varchar(20),
  `optin_date` datetime DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY  (`id`),
  KEY `campaign_id` (`campaign_id`)
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_cart_categories` (
  ...
  `cols` tinyint(1),
  `search_index` tinyint(1),
  `public` tinyint(1),
  `owner` mediumint(6),
  `created` datetime DEFAULT '0000-00-00 00:00:00',
  `hide` TINYINT( 1 ),
  `members_only` TINYINT( 0 ),
  PRIMARY KEY  (`id`),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_cart_coupon_codes` (
  ...
  `current_customers_only` tinyint(1),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_cart_refunds` (
  ...
  `reason` text,
  `order_id` varchar(14),
  `type` TINYINT( 1 ) COMMENT  '1 = Refund / 2 = Chargeback',
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_cart_sessions` (
  ...
  `status` tinyint(1) COMMENT '0 = unpaid, 1 = paid, 2 = pending payment, 3 = Partial refund, 4= full refung, 9 = rejected',
  `member_id` varchar(20),
  ...
  `saw_upsell` TINYINT( 1 ),
  `dependencies` TINYINT( 1 ),
  `dependency_submitted` TEXT,
  `invoice_id` varchar(35),
  `return_time_out` DATETIME DEFAULT '0000-00-00 00:00:00',
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_contacts` (
  ...
  `email` varchar(125),
  `bounce_notice` DATETIME DEFAULT '0000-00-00 00:00:00',
  `last_updated` datetime DEFAULT '0000-00-00 00:00:00',
  `last_updated_by` mediumint(6),
  `last_action` datetime DEFAULT '0000-00-00 00:00:00',
  `next_action` datetime DEFAULT '0000-00-00 00:00:00',
  `source` mediumint(5),
  `account` varchar(10),
  `status` tinyint(1) COMMENT '1 = Active, 2 = Converted, 3 = Dead',
  `public` tinyint(1) COMMENT '1 = All can see, 0 = admin and owner, 2 = permission group only',
  `email_pref` enum('html','text'),
  `converted` tinyint(1),
  `converted_id` int(9) COMMENT 'Matches ppSD_lead_conversion ID',
  `email_optout` datetime DEFAULT '0000-00-00 00:00:00',
  `sms_optout` datetime DEFAULT '0000-00-00 00:00:00',
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_custom_actions` (
  ...
  `when` tinyint(1) COMMENT '1 = before, 2 = after',
  `type` tinyint(1) COMMENT '1 = php include, 2 = email, 3 = mysql query, 4 = curl',
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_email_trackback` (
  ...
  `last_viewed` datetime default '0000-00-00 00:00:00',
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_events` (
  ...
  `starts` datetime DEFAULT '0000-00-00 00:00:00',
  `ends` datetime DEFAULT '0000-00-00 00:00:00',
  `start_registrations` datetime DEFAULT '0000-00-00 00:00:00',
  `early_bird_end` datetime DEFAULT '0000-00-00 00:00:00',
  `close_registration` datetime DEFAULT '0000-00-00 00:00:00',
  `max_rsvps` mediumint(6),
  `members_only_rsvp` tinyint(1),
  `members_only_view` tinyint(1),
  `allow_guests` tinyint(1),
  `max_guests` smallint(2),
  `description` mediumtext,
  `post_rsvp_message` mediumtext,
  `online` tinyint(1) COMMENT '1 = online event, 2 = offline event',
  `url` varchar(255),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_event_products` (
  ...
  `product_id` varchar(35),
  `event_id` varchar(9),
  `type` tinyint(1) COMMENT '1 = rsvp, 2 = guest rsvp, 3 = addon, 4 = early bird, 6= early bird member, 5 = member pricing',
  PRIMARY KEY  (`id`),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_event_rsvps` (
  ...
  `email` varchar(85),
  `bounce_notice` DATETIME DEFAULT '0000-00-00 00:00:00',
  `type` tinyint(1) COMMENT '1 = Primary / 2 = Guest',
  `primary_rsvp` varchar(21) COMMENT 'For guests, this is the main RSVP ID.',
  `date` datetime DEFAULT '0000-00-00 00:00:00',
  `order_id` varchar(15),
  `status` tinyint(1) COMMENT '1 = Paid / 2 = Pending Payment',
  `checked_in_by` mediumint(5),
  `arrived` tinyint(1),
  `arrived_date` datetime DEFAULT '0000-00-00 00:00:00',
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_fields` (
  ...
  `logic` tinyint(1),
  `logic_dependent` tinyint(1) COMMENT '1 = Top level logic / 2 = Second level logic',
  `desc` mediumtext,
  ...
  `encrypted` tinyint(1),
  `sensitive` tinyint(1) COMMENT 'Hides data on previews.',
  `maxlength` smallint(3),
  `settings` mediumtext,
  `permissions_group` tinyint(3),
  `primary` tinyint(1),
  `static` tinyint(1),
  `data_type` tinyint(1) COMMENT '1 = all, 2 = letters, 3 = numbers, 4 = letters/numbers',
  `min_len` mediumint(5),
  `scope_member` tinyint(1),
  `scope_contact` tinyint(1),
  `scope_rsvp` tinyint(1),
  `scope_account` tinyint(1),
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8";
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_fieldsets` (
  ...
  `order` smallint(3),
  `columns` tinyint(1),
  `logic_dependent` tinyint(1),
  `static` tinyint(1) COMMENT '1 = Default, no delete, 2 = Custom, 0 = Custom but not visible (events, etc.)',
  `owner` mediumint(5),
  `billing` tinyint(1) COMMENT 'Used to prevent displaying billing data in dropdowns to avoid confusion.',
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8";
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_form_closed_sessions` (
  ...
  `used` tinyint(1),
  `form_id` varchar(25),
  `date_issued` datetime DEFAULT '0000-00-00 00:00:00',
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_form_products` (
  ...
  `form_id` varchar(25),
  `product_id` varchar(35),
  `qty_control` tinyint(1) COMMENT '1 = Add 1, 2 = user select',
  `type` tinyint(1) COMMENT '1 = Required / 2 = Optional',
  `order` SMALLINT( 3 ),
  PRIMARY KEY  (`id`),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_history` (
  ...
  `type` tinyint(1) COMMENT '1 = member, 2 = contact, 3 = rsvp, 4 = other',
  PRIMARY KEY  (`id`),
  KEY `owner` (`owner`),
  KEY `user_id` (`user_id`),
  KEY `act_id` (`act_id`)
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_invoices` (
  `id` varchar(35),
  `date` datetime DEFAULT '0000-00-00 00:00:00',
  `last_reminder` datetime DEFAULT '0000-00-00 00:00:00',
  `total_reminders` smallint(3),
  `date_due` datetime DEFAULT '0000-00-00 00:00:00',
  `order_id` varchar(14) COMMENT 'Mainly used to associate totals and shipping data',
  `member_id` varchar(20),
  `member_type` enum('member','contact'),
  `status` tinyint(1) COMMENT '0 = Unpaid, 1 = Paid, 2 = Partial Payment, 3 = Overdue, 4 = Dead',
  `salt` varchar(4),
  `hash` varchar(60),
  `tax_rate` decimal(5,2),
  `shipping_rule` mediumint(5),
  ...
  `hourly` decimal(8,2),
  `rsvp_id` varchar(21),
  `rolling_invoice` TINYINT(1) NULL,
  `auto_inform` TINYINT( 1 ),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_lead_conversion` (
  `id` int(9) auto_increment,
  `date` datetime DEFAULT '0000-00-00 00:00:00',
  `began` datetime DEFAULT '0000-00-00 00:00:00',
  `contact_id` varchar(20),
  `user_id` varchar(20),
  `owner` mediumint(6),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_link_tracking` (
  ...
  `email_id` varchar(35),
  `clicked` mediumint(4),
  `first_clicked` datetime DEFAULT '0000-00-00 00:00:00',
  `last_clicked` datetime DEFAULT '0000-00-00 00:00:00',
  `link` varchar(255),
  `campaign_id` varchar(11),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_members` (
  ...
  `email` varchar(110),
  `bounce_notice` DATETIME DEFAULT '0000-00-00 00:00:00',
  `joined` datetime default '0000-00-00 00:00:00',
  `last_renewal` DATETIME DEFAULT '0000-00-00 00:00:00',
  `last_action` datetime DEFAULT '0000-00-00 00:00:00',
  ...
  `concurrent_login_date` datetime default '0000-00-00 00:00:00',
  `public` tinyint(1),
  `owner` mediumint(6),
  `email_pref` enum('html','text'),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_newsletters_subscribers` (
  ...
  `added` datetime DEFAULT '0000-00-00 00:00:00',
  `expires` datetime DEFAULT '0000-00-00 00:00:00',
  `unsubscribed` datetime DEFAULT '0000-00-00 00:00:00',
  `status` tinyint(1) default '1' COMMENT '1 = subscribed, 0 = unsubscribed',
  `activation_code` varchar(35),
  `double_optin` datetime DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY  (`id`),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_notes` (
  ...
  `public` tinyint(1) COMMENT '2 = broadcast , 1 = all can see, 0 = creator and admin only',
  `deadline` datetime DEFAULT '0000-00-00 00:00:00',
  `value` decimal(10,2),
  `for` mediumint(5),
  `remove_from_cp` tinyint(1),
  `complete` TINYINT( 1 ) ,
  `completed_by` MEDIUMINT( 5 ),
  `completed_on` DATETIME DEFAULT '0000-00-00 00:00:00',
  `priority` TINYINT( 1 ),
  `encrypt` TINYINT( 1 ),
  `pin` TINYINT(1) DEFAULT '0',
  `seen` TINYINT(1) DEFAULT '0',
  `seen_date` DATETIME DEFAULT '0000-00-00 00:00:00',
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_products` (
  `id` varchar(35),
  `associated_id` varchar(20) COMMENT 'Event, etc.',
  `name` varchar(85),
  `tagline` varchar(255),
  `description` text,
  ...
  `threshold_date_set` datetime DEFAULT '0000-00-00 00:00:00',
  `hide` tinyint(1),
  `hide_in_admin` tinyint(1),
  `weight` decimal(8,2),
  `member_type` MEDIUMINT( 5 ) ,
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_staff_in` (
  `id` varchar(100),
  `salt` varchar(4),
  `masterlog` datetime DEFAULT '0000-00-00 00:00:00',
  `username` varchar(100),
  `expires` datetime DEFAULT '0000-00-00 00:00:00',
  `remember` tinyint(1),
  `ip` varchar(25),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_subscriptions` (
  ...
  `date` datetime DEFAULT '0000-00-00 00:00:00',
  `last_renewed` DATETIME DEFAULT '0000-00-00 00:00:00',
  `next_renew` datetime DEFAULT '0000-00-00 00:00:00',
  `next_renew_keep` datetime DEFAULT '0000-00-00 00:00:00',
  `price` decimal(15,2),
  `retry` smallint(3),
  `product` varchar(35),
  `status` tinyint(1),
  ...
  `paypal` tinyint(1) COMMENT '1 = PayPal Handles It',
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_tags` (
  ...
  `tag` varchar(35),
  `item_id` varchar(40),
  `item_type` TINYINT( 1 ) COMMENT  '1 = Upload',
  `owner` mediumint(6),
  PRIMARY KEY  (`id`),
  KEY `item_id` (`item_id`),
  KEY `tag` (`tag`)
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_templates` (
  ...
  `type` tinyint(1) COMMENT '1 = Header, 2 = Footer, 3 = Custom template, 0 = Template, 4 = page',
  `section` varchar(35),
  `content` mediumtext,
  `secure` tinyint(1),
  `static` tinyint(1),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_templates_email` (
  ...
  `bcc` varchar(255),
  `content` mediumtext,
  `format` tinyint(1) COMMENT '1 = html / 0 = plain text',
  `status` tinyint(1),
  `save` tinyint(1),
  `track` tinyint(1),
  `track_links` tinyint(1),
  `caller_tags` text,
  `custom` tinyint(1) COMMENT 'If this was custom created by the user.',
  `owner` mediumint(6),
  `public` tinyint(1),
  `created` datetime DEFAULT '0000-00-00 00:00:00',
  ...
  `static` tinyint(1),
  `default_for` tinyint(1) COMMENT '1 = email, 2 = targeted, 3 = scheduled',
  `theme` varchar(25),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_uploads` (
  ...
  `cp_only` tinyint(1) COMMENT '1 = only visible on admin CP',
  `note_id` varchar(35),
  `owner` mediumint(9),
  `email_id` varchar(35),
  `byuser` tinyint(1),
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_widgets` (
  ...
  `version` VARCHAR( 6 ) ,
  `installed` DATETIME DEFAULT '0000-00-00 00:00:00',
...
$create[] = "CREATE TABLE IF NOT EXISTS `ppSD_widgets_menus` (
  ...
  `title` varchar(125),
  `link` varchar(255),
  `link_type` tinyint(1) COMMENT '1 = cms page, 2 = full url, 3 = onsite build url',
