...
if (is_writable($path . '/admin/sd-system')) {
    ...
    echo "<hr><hr>SALT FILE:<br /><textarea style=\"width:100%;height:300px;\">" . $saltfile . "</textarea>";
    //echo "admin/sd-system not writable. Could not proceed."; exit;
}
...
if (is_writable($path . '/admin/sd-system')) {
    ...
    echo "<hr><hr>CONFIG FILE:<br /><textarea style=\"width:100%;height:300px;\">" . $config . "</textarea>";
}
