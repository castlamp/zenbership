        ...
        <div class="pad24t popupbody">
            ...
            <div class="field">
                ...
                <div class="field_entry_top">
                    <input type="text" name="message" id="sms-message" style="width:100%;" />

                    <p class="contact_frequency_dets">Recommend 160 characters. Caller tags are available for use. Use any
            ...
            <div class="field">
                <label class="top">Media URL</label>

                <div class="field_entry_top">
                    <input type="text" placeholder="http://www.yoursite.com/someimage.jpg" name="mediaUrl" id="mediaurl" style="width:100%;" />

                    <p class="contact_frequency_dets"><b>IMPORTANT:</b> This is only available with certain providers. Please consult your programmatic SMS provider for details.</p>
                </div>
            </div>
        </div>
