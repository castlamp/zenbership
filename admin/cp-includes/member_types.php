 ...
 */
$permission = 'member_types';
$check = $admin->check_permissions($permission, $employee);
if ($check != '1') {
    $admin->show_no_permissions();
} else {
    $table         = 'ppSD_member_types';
    $order         = 'ppSD_member_types.name';
    $dir           = 'ASC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
    ...
    <div id="topblue" class="fonts small">
        <div class="holder">
            ...
            <div class="floatleft" id="tb_left">
                <span><b>Membership Types</b></span>
                <span class="div">|</span>
    ...
    <div id="mainsection">
        <form id="table_checkboxes">
            ...
            <div id="bottom_delete">
                <div class="pad16"><span class="small gray caps bold" style="margin-right:24px;">With Selected:</span><input type="button" value="Delete" class="del" onclick="return compile_delete('<?php echo $table; ?>','table_checkboxes');"/>
                </div>
            </div>
