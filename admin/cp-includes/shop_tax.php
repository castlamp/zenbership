        ...
        <div id="topblue" class="fonts small">
            <div class="holder">
                ...
                <div class="floatleft" id="tb_left">
                    ...
                    <span><b>Listing Tax Classes</b></span>
			...
			<span id="innerLinks">
				...
				<a href="null.php" onclick="return popup('<?php echo $permission; ?>-edit','id=');">Create New Tax
                    Class</a>
            ...
            <div class="pad24">
                ...
                <div class="col50">
                    ...
                    if (!empty($employee['options'][$optname])) {
                        ...
                        $thefilters = array(
                            'name:ppSD_tax_classes::',
                            'state:ppSD_tax_classes::',
                            'country:ppSD_tax_classes::',
                            'percent_physical:ppSD_tax_classes::',
                            'percent_digital:ppSD_tax_classes::',
                        );
