 ...
 */
$permission = 'email-queue';
$check = $admin->check_permissions($permission, $employee);
if ($check != '1') {
    $admin->show_no_permissions();

} else {
    $table         = 'ppSD_email_scheduled';
    $order         = 'ppSD_email_scheduled.added';
    $dir           = 'DESC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
    ...
    <div id="topblue" class="fonts small">
        <div class="holder">
            ...
            <div class="floatleft" id="tb_left">
                ...
                <span><b>Listing Outgoing Queue</b></span>
            ...
            <div class="col50">
                ...
                <div class="field">
                    ...
                    <div class="field_entry">
                        ...
                        <select name="filter[user_type]" style="width:110px;" class="filterinputtype">
                ...
                <div class="field">
                    ...
                    <div class="field_entry">
                        ...
                        <input type="text" id="email" value="" name="email_name"
                               onkeyup="return autocom('name','id','name','ppSD_saved_email_content','name','');"
                               style="width:110px;" class="filterinputtype"/>

                        <input type="hidden" name="filter[source]" id="email_id" value=""/>
