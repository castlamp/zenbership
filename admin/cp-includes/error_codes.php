 ...
 */
$permission = 'error_codes';
$check = $admin->check_permissions($permission, $employee);
if ($check != '1') {
    $admin->show_no_permissions();

} else {
    $table         = 'ppSD_error_codes';
    $order         = 'ppSD_error_codes.code';
    $dir           = 'ASC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
    ...
    <form action="cp-includes/get_table.php" id="table_filters" method="post" onsubmit="return update_table();">
        ...
        <input type="hidden" name="hide_checkbox" value="1"/>
            ...
            <div class="pad24">
                ...
                <div class="col50">
                    ...
                    if (!empty($employee['options'][$optname])) {
                        ...
                        $thefilters = array(
                            'code:ppSD_error_codes::',
                            'msg:ppSD_error_codes::',
                            'lang:ppSD_error_codes::',
                        );
