...
if ($check != '1') {
    ...
    $order         = 'ppSD_cart_coupon_codes.id';
    $dir           = 'ASC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
        ...
        <div id="topblue" class="fonts small">
            <div class="holder">
                ...
                <div class="floatleft" id="tb_left">
                    ...
                    <span><b>Listing Promotional Codes</b></span>
			...
			<span id="innerLinks">
				...
				<a href="null.php" onclick="return popup('promo_code-edit');">Add Promo Code</a>
            ...
            <div class="pad24">
                ...
                <div id="filters_top">
	   			...
	   			<span><?php
                    ...
                    echo $admin->alpha_list('promo_codes', 'id', 'ppSD_cart_coupon_codes');
                ...
                <div class="col50">
                    ...
                    if (!empty($employee['options'][$optname])) {
                        ...
                        $thefilters = array(
                            'name:ppSD_cart_coupon_codes::',
                            'dollars_off:ppSD_cart_coupon_codes::',
                            'percent_off:ppSD_cart_coupon_codes::',
                            'max_use_overall:ppSD_cart_coupon_codes::',
                            'date_start:ppSD_cart_coupon_codes:1:1',
                            'date_end:ppSD_cart_coupon_codes:1:1',
                            'cart_minimum:ppSD_cart_coupon_codes::',
                        );
                ...
                <div class="col50">
                    ...
                    <div class="field">
                        ...
                        <label class="less">Scope</label>

                        <div class="field_entry_less">

                            <select name="filter[current_customers_only]" style="width:150px;">
