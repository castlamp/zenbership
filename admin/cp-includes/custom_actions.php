...
if ($check != '1') {
    ...
    $table         = 'ppSD_custom_actions';
    $order         = 'ppSD_custom_actions.name';
    $dir           = 'ASC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
    ...
    <div id="topblue" class="fonts small">
        <div class="holder">
            ...
            <div class="floatleft" id="tb_left">
                ...
                <span id="innerLinks">
                    <a href="returnnull.php" onclick="return popup('create_hook','','1');">Create Hook</a>
                </span>
            </div>
    ...
    <div class="col50">
        ...
        <div class="field">
            ...
            <div class="field_entry_less">
                <select name="filter[active]" style="width:150px;">
                    <option value=""></option>
        ...
        <div class="field">
            <label class="less">When?</label>
            <div class="field_entry_less">
                <select name="filter[active]" style="width:150px;">
                    <option value=""></option>
                    <option value="1">Before Task</option>
                    <option value="2">After Task</option>
                </select>
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="field_entry_less">
                <select name="filter[type]" style="width:150px;">
                    <option value=""></option>
                    <option value="1">PHP Code Execution</option>
                    <option value="2">E-Mail Dispatcher</option>
                    <option value="3">MySQL Command Execution</option>
                    <option value="5">Outside Connection</option>
                </select>
            </div>
        </div>
