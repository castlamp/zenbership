 ...
 */
$permission = 'email_milestones';
$check = $admin->check_permissions($permission, $employee);
if ($check != '1') {
    $admin->show_no_permissions();

} else {
    $table         = 'ppSD_tracking_activity';
    $order         = 'ppSD_tracking_activity.date';
    $dir           = 'DESC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
        ...
        <div id="topblue" class="fonts small">
            <div class="holder">
                ...
                <div class="floatleft" id="tb_left">
                    ...
                    <span><b>Emailing Milestone Logs</b></span>
			...
			<span id="innerLinks">
				...
				<a href="index.php?l=email_outbox">Outbox</a>
				<a href="index.php?l=email_tracking">Readership</a>
				<a href="index.php?l=email_clicks">Link Clicks</a>
            ...
            <div class="pad24">
                ...
                <div class="col50">
                    ...
                    if (!empty($employee['options'][$optname])) {
                        ...
                        // 	track_id	type	act_id	value	campaign_id	date
                        $thefilters = array(
                            'value:1:1:',
                            'date:1:1:',
                        );
                    ...
                    <div class="field">
                        ...
                        <div class="field_entry_less">
                            <select name="filter[type]" style="width:150px;">
                                ...
                                <option value="contact">Contact Generated</option>
