...
if ($check != '1') {
    ...
    <div id="topblue" class="fonts small">
        <div class="holder">
			...
			<span id="innerLinks">
				...
				<a href="returnnull.php" onclick="return popup('build_criteria_type','type=campaign','1');">Create
                    Automated Campaign</a>

                <a href="returnnull.php" onclick="return popup('campaign-optin-add','','1');">Create Opt-in Campaign</a>

				<a href="index.php?l=email_outbox">E-Mail Outbox</a>

				<a href="index.php?l=email_tracking">E-Mail Tracking Logs</a>
    ...
    <div class="col50">
        ...
        <div class="field">
            ...
            <div class="field_entry_less">
                ...
                <select name="filter[type]" style="width:150px;">
                    ...
                    <option value="email">E-Mail Campaign</option>
        ...
        <div class="field">
            ...
            <label class="less">Opt-in</label>

            <div class="field_entry_less">

                <select name="filter[optin_type]" style="width:150px;">

                    <option value=""></option>

                    <option value="criteria">Automated Campaign</option>

                    <option value="single_optin">Single Opt-in</option>
        ...
        <div class="field">
            ...
            <label class="less">User Type</label>

            <div class="field_entry_less">

                <select name="filter[user_type]" style="width:150px;">
        ...
        <div class="field">
            ...
            <label class="less">Kill Condition</label>

            <div class="field_entry_less">

                <input type="checkbox" name="filter[user_type]" value="kill_on_reply"/> Kill On Reply<br/>

                <input type="checkbox" name="filter[user_type]" value="kill_on_open"/> Kill On Open<br/>
