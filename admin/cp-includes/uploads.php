...
if ($check != '1') {
    ...
    if ($employee['permissions']['admin'] != '1') {
        $force_filters[] = $employee['id'] . '||owner||eq||ppSD_uploads';
    ...
    <form action="cp-includes/get_table.php" id="table_filters" method="post" onsubmit="return update_table();">
        ...
        <div id="topblue" class="fonts small">
			...
			<span id="innerLinks">
				<a href="null.php" onclick="return popup('upload-files','cp_only=1&item_id=');">Upload Files for Staff</a>
				<a href="null.php" onclick="return popup('upload-files','cp_only=0&item_id=zen_public');">Upload Files for Members</a>
            </span>
