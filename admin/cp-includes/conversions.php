...
if ($check != '1') {
    ...
    $table                = 'ppSD_lead_conversion';
    $order                = 'ppSD_lead_conversion.date';
    $dir                  = 'DESC';
    $display              = '50';
    $page                 = '1';
    $defaults             = array(
    ...
    if ($employee['permissions']['admin'] != '1') {
        $force_filters[] = $employee['id'] . '||owner||eq||ppSD_lead_conversion';
                ...
                <div class="col50">
                    ...
                    if (!empty($employee['options'][$opnm])) {
                        ...
                        $thefilters = array(
                            ...
                            'estimated_value:::',
                            'percent_change:::',
                            'date:ppSD_lead_conversion:1:1',
                            'began:ppSD_lead_conversion:1:1'
                        );
        ...
        <form id="table_checkboxes">
            ...
            <div id="bottom_delete">
                <div class="pad16">
                    ...
                    <div id="sum_list">
                        <span class="sl_key">Estimated Value</span>
                        <span class="sl_value" id="math1"><?php echo $gen_table['math']; ?></span>
                        <span class="sl_key">Converted Value</span>
                        <span class="sl_value" id="math1"><?php echo $gen_table['math1']; ?></span>
                    </div>
