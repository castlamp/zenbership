...
if ($check != '1') {
    ...
    $order         = 'ppSD_cart_categories.name';
    $dir           = 'ASC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
        ...
        <div id="topblue" class="fonts small">
            <div class="holder">
                ...
                <div class="floatleft" id="tb_left">
                    ...
                    <span><b>Listing Shop Categories</b></span>
            ...
            <div class="pad24">
                ...
                <div class="col50">
                    ...
                    if (!empty($employee['options'][$opnm])) {
                        ...
                        $thefilters = array(
                            'name:ppSD_cart_categories::',
                            'description:ppSD_cart_categories::',
                        );
                ...
                <div class="col50">
                    ...
                    <div class="field">
                        ...
                        <label class="less">In Category</label>

                        <div class="field_entry_less">

                            <select name="filter[subcategory]" style="width:150px;">
        ...
        <form id="table_checkboxes">
            ...
            <div id="bottom_delete">
                <div class="pad16"><span class="small gray caps bold"
                    ...
                    <input type="button" value="Delete Category &amp; Products" class="del"
                           onclick="return compile_delete('<?php echo $table; ?>','table_checkboxes','1');"/></div>
            </div>
