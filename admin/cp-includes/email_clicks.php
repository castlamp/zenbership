 ...
 */
$permission = 'email_clicks';
$check = $admin->check_permissions($permission, $employee);
if ($check != '1') {
    $admin->show_no_permissions();

} else {
    $table         = 'ppSD_link_tracking';
    $order         = 'ppSD_link_tracking.last_clicked';
    $dir           = 'DESC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
    ...
    $force_filters = array(
        '1920-01-01 00:01:01||first_clicked||neq||ppSD_link_tracking',
    );
        ...
        <div id="topblue" class="fonts small">
            <div class="holder">
                ...
                <div class="floatleft" id="tb_left">
                    ...
                    <span><b>Emailing Link Click Tracking Logs</b></span>
			...
			<span id="innerLinks">
				...
				<a href="index.php?l=email_tracking">Readership Tracking</a>
