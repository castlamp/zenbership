...
if ($check != '1') {
    ...
    $order         = 'ppSD_payment_gateways.primary DESC, ppSD_payment_gateways.active';
    $dir           = 'DESC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
    ...
    <form action="cp-includes/get_table.php" id="table_filters" method="post" onsubmit="return update_table('1');">
        ...
        <input type="hidden" name="hide_checkbox" value=""/>
        ...
        <div id="topblue" class="fonts small">
            <div class="holder">
                ...
                <div class="floatleft" id="tb_left">
                    ...
                    <span><b>Listing Payment Gateways</b></span>
            ...
            <div class="pad24">
                ...
                <div class="col50">
                    ...
                    if (!empty($employee['options'][$optname])) {
                        ...
                        $thefilters = array(
                            'name:ppSD_payment_gateways:0:0',
                            'fee_flat:ppSD_payment_gateways:0:0',
                            'fee_percent:ppSD_payment_gateways:0:0',
                        );
                ...
                <div class="col50">
                    ...
                    <div class="field">
                        ...
                        <div class="field_entry_less">
                            ...
                            <select name="filter[api]" style="width:150px;">

                                <option value=""></option>

                                <option value="1">API</option>

                                <option value="0">Non-API</option>
    ...
    <div id="mainsection">
        ...
        <form id="table_checkboxes">
            ...
            <!--<div id="bottom_delete"><div class="pad16"><span class="small gray caps bold" style="margin-right:24px;">With Selected:</span><input type="button" value="Delete" class="del" onclick="return compile_delete('<?php echo $table; ?>','table_checkboxes');" /></div></div>-->
