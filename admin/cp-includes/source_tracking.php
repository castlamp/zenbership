...
if ($check != '1') {
    ...
    $table         = 'ppSD_source_tracking';
    $order         = 'ppSD_source_tracking.date';
    $dir           = 'ASC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
            ...
            <div class="pad24">
                ...
                <div class="col50">
                    ...
                    if (!empty($employee['options'][$opnm])) {
                        ...
                        $thefilters = array(
                            'source_id:ppSD_source_tracking::',
                            'referrer:ppSD_source_tracking::',
                            'date:ppSD_source_tracking:1:1',
                            'converted_date:ppSD_source_tracking:1:1',
                        );
