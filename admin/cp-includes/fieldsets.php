...
if ($check != '1') {
    ...
    $force_filters = array('-||static||noteq||ppSD_fieldsets');
    ...
    <form action="cp-includes/get_table.php" id="table_filters" method="post" onsubmit="return update_table();">
        ...
        <div id="topblue" class="fonts small">
			...
			<span id="innerLinks">
				...
				<a href="null.php" onclick="return popup('fieldset-add','','1');">Create Fieldset</a>
                ...
                <div class="col50">
                    ...
                    <div class="field">
                        ...
                        <div class="field_entry">
                            ...
                            <input type="text" id="name" value="" name="filter[name]" class="filterinputtype"/>
