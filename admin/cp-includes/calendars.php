        ...
        <div id="topblue" class="fonts small">
            <div class="holder">
                ...
                <div class="floatleft" id="tb_left">
                    ...
                    <span><b>Listing Calendars</b></span>
			...
			<span id="innerLinks">
				...
				<a href="null.php" onclick="return popup('calendar-edit');">Create Calendar</a>
                ...
                <div class="col50">
                    ...
                    <div class="field">
                        ...
                        <div class="field_entry">
                            ...
                            <select name="filter[members_only]" style="width:110px;" class="filterinputtype">
        ...
        <form id="table_checkboxes">
            ...
            <div id="bottom_delete">
                <div class="pad16"><span class="small gray caps bold"
                    ...
                    <input type="button" value="Delete Calendar and Events" class="del"
