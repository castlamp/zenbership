...
if ($check != '1') {
    ...
    $order         = 'ppSD_subscriptions.next_renew';
    $dir           = 'ASC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
        ...
        'page'    => $page,
        'display' => $display,
        'filters' => array('1||status||eq||ppSD_subscriptions'),
    );
    $force_filters = array();
    ...
    <div id="topblue" class="fonts small">
        <div class="holder">
            ...
            <div class="floatleft" id="tb_left">
                ...
                <span><b>Listing Subscriptions</b></span>
...
<?php
$filters = (! empty($_GET['filters'])) ? filtersQs($_GET['filters']) : '';
if (! empty($filters['member_id'])) {
    $use = 'user_id=' . $filters['member_id'];
} else {
    $use = '';
}
?>
                <a href="prevent_null.php" onclick="return popup('subscription-add','<?php echo $use; ?>');">Create Subscription</a>
        ...
        <div class="pad24">
            ...
            <div class="col50">
                ...
                if (!empty($employee['options'][$opnm])) {
                    ...
                    $thefilters = array(
                        'id:ppSD_subscriptions::',
                        'status:ppSD_subscriptions::',
                        'next_renew:ppSD_subscriptions:1:1',
                        'last_renewed:ppSD_subscriptions:1:1',
                        'date:ppSD_subscriptions:1:1',
                        'cancel_date:ppSD_subscriptions:1:1',
                    );
            ...
            <div class="col50">
                ...
                <div class="field">
                    ...
                    <div class="field_entry_less">
                        ...
                        <select name="filter[product]" style="width:150px;">

                            <option value=""></option>

                            <?php

                            echo $admin->product_list('', '1');
