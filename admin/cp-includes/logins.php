        ...
        <div id="topblue" class="fonts small">
            <div class="holder">
                ...
                <div class="floatleft" id="tb_left">
                    <span><b>Listing Login Activity</b></span>
                    <span class="div">|</span>
            ...
            <div class="pad24">
                ...
                <div class="col50">
                    ...
                    if (!empty($employee['options'][$opnm])) {
                        ...
                        $thefilters = array(
                            'date:ppSD_logins:1:1',
                            'session_id:ppSD_logins::',
                            'member_id:ppSD_logins::',
                            'ip:ppSD_logins::',
                            'notes:ppSD_logins::',
                        );
                ...
                <div class="col50">
                    ...
                    <div class="field">
                        ...
                        <div class="field_entry_less">
                            ...
                            <select name="filter[typel]" style="width:150px;">
