 ...
 */
$permission = 'product';
$check = $admin->check_permissions('product', $employee);
if ($check != '1') {
    $admin->show_no_permissions();
} else {
    $table         = 'ppSD_products';
    $order         = 'ppSD_products.category ASC, ppSD_products.name';
    $dir           = 'ASC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
    ...
    $force_filters = array(
        '-||associated_id||eq||ppSD_products',
        '1||hide_in_admin||neq||ppSD_products',
        '-||invoice_id||eq||ppSD_products',
        '1||hide||neq||ppSD_products'
    );
    ...
    <div id="topblue" class="fonts small">
        <div class="holder">
            ...
            <div class="floatleft" id="tb_left">
                ...
                <span><b>Listing Products</b></span>
			...
			<span id="innerLinks">
				...
				<a href="prevent_null.php" onclick="return popup('product-add','','1');">Create Product</a>

                <a href="prevent_null.php" onclick="return popup('category-edit','');">Create Category</a>

				<!--<a href="null.php" onclick="return load_page('product','add');">Add Product</a>-->
    ...
    <div id="filters" class="fonts smaller">
        <div class="pad24">
            ...
            <div id="filters_top">
                ...
                <div id="filters_left">
	   			...
	   			<span><?php
                    ...
                    echo $admin->alpha_list('products', 'name', 'ppSD_products');
            ...
            <div class="col50">
                ...
                $opt_filters = $db->get_option('product_filters');

                if (!empty($employee['options']['product_filters'])) {
                    $thefilters = explode(',', $employee['options']['product_filters']);
            ...
            <div class="col50">
                <div class="field">
                    <label class="less">Category</label>
                    <div class="field_entry_less">
                        <select name="filter[category]" style="width:150px;">
                            <option value="" selected="selected"></option>
                            <?php
                            echo $admin->cart_category_select('na');
                            ?>

                        </select>
                    </div>
                    <input type="hidden" name="filter_type[category]" value="eq" />
                </div>

                <div class="field">
                    <label class="less">Type</label>
                    <div class="field_entry_less">
                        <select name="filter[type]" style="width:150px;">
                            <option value=""></option>
                            <option value="1">Single Purchase</option>
                            <option value="2">Subscription</option>
                            <option value="3">Trial Product</option>
                        </select>
                    </div>
                    <input type="hidden" name="filter_type[type]" value="eq" />
                </div>

                <div class="field">
                    <label class="less">Visibility</label>
                    <div class="field_entry_less">
                        <select name="filter[hide]" style="width:150px;">
                            <option value=""></option>
                    ...
                    <input type="hidden" name="filter_type[hide]" value="eq" />
                </div>

                <div class="field">
                    <label class="less">Physical</label>
                    <div class="field_entry_less">
                        <select name="filter[physical]" style="width:150px;">
                            <option value=""></option>
                            <option value="0">Digital</option>
                            <option value="1">Physical</option>
                        </select>
                    </div>
                    <input type="hidden" name="filter_type[physical]" value="eq" />
                </div>
