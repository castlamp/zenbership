...
if ($check != '1') {
    ...
    $order         = 'ppSD_shipping_rules.priority ASC, ppSD_shipping_rules.name';
    $dir           = 'ASC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
        ...
        <div id="topblue" class="fonts small">
            <div class="holder">
                ...
                <div class="floatleft" id="tb_left">
                    ...
                    <span><b>Listing Cart Terms</b></span>
			...
			<span id="innerLinks">
				...
				<a href="null.php" onclick="return popup('<?php echo $permission; ?>-edit','id=','0');">Create New
                    Shipping Rule</a>
            ...
            <div class="pad24">
                ...
                <div class="col50">
                    ...
                    if (!empty($employee['options'][$optname])) {
                        ...
                        $thefilters = array(
                            'name:ppSD_shipping_rules::',
                            'cost:ppSD_shipping_rules::',
                            'country:ppSD_shipping_rules::',
                            'state:ppSD_shipping_rules::',
                        );
                    ...
                    <div class="field">
                        ...
                        <div class="field_entry">
                            ...
                            <select name="filter[type]">
                                ...
                                <option value="total">Total-based</option>

                                <option value="product">Product-based</option>

                                <option value="flat">Flat Rate Option</option>
