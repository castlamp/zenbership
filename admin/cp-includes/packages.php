 ...
 */
$permission = 'packages';
$check = $admin->check_permissions('packages', $employee);
if ($check != '1') {
    $admin->show_no_permissions();

} else {
    $table         = 'ppSD_packages';
    $order         = 'ppSD_packages.name';
    $dir           = 'DESC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
        ...
        <div id="topblue" class="fonts small">
            <div class="holder">
                ...
                <div class="floatleft" id="tb_left">
                    ...
                    <span><b>Listing Packages</b></span>
			...
			<span id="innerLinks">
				...
				<a href="prevent_null.php" onclick="return popup('package','','');">Create Package</a>
            ...
            <div class="pad24">
                ...
                <div id="filters_top">
	   			...
	   			<span><?php
                    ...
                    echo $admin->alpha_list('packages', 'name', 'ppSD_packages');
