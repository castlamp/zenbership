 ...
 */
$permission = 'shop_terms';
$check = $admin->check_permissions($permission, $employee);
if ($check != '1') {
    $admin->show_no_permissions();

} else {
    $table         = 'ppSD_cart_terms';
    $order         = 'ppSD_cart_terms.name';
    $dir           = 'ASC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
    ...
    <form action="cp-includes/get_table.php" id="table_filters" method="post" onsubmit="return update_table();">
        ...
        <div id="topblue" class="fonts small">
			...
			<span id="innerLinks">
				...
				<a href="null.php" onclick="return popup('<?php echo $permission; ?>-edit','id=','1');">Create New
                    Terms</a>
            ...
            <div class="pad24">
                ...
                <div class="col50">
                    ...
                    if (!empty($employee['options'][$optname])) {
                        ...
                        $thefilters = array(
                            'name:ppSD_cart_terms::',
                            'terms:ppSD_cart_terms::',
                        );
