    ...
    <div id="topblue" class="fonts small">
        <div class="holder">
			...
			<span id="innerLinks">
				...
				<a href="index.php?l=transactions">Billing Report</a>
            ...
            <div id="bottom_delete">
                <div class="pad16">
                    <div id="sum_list">
                        ...
                        <span class="sl_key">Taxes</span>
                        <span class="sl_value" id="math2"><?php echo $gen_table['math1']; ?></span>
                        <span class="sl_key">Savings</span>
                        <span class="sl_value" id="math3"><?php echo $gen_table['math2']; ?></span>
                        <span class="sl_key">Fees</span>
                        <span class="sl_value" id="math4"><?php echo $gen_table['math3']; ?></span>
                    </div>
                    <span class="small gray caps bold" style="margin-right:24px;">With Selected:</span>
