    ...
    <form action="cp-includes/get_table.php" id="table_filters" method="post" onsubmit="return update_table();">
        ...
        <div id="topblue" class="fonts small">
			...
			<span id="innerLinks">
				...
				<a href="null.php" onclick="return popup('content_type','','1');">Create Content</a>

				<!--<a href="index.php?l=menus" onclick="return popup('menus','','1');">Menus</a>-->
