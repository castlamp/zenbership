...
if ($check != '1') {
    ...
    $order         = 'ppSD_login_announcements.starts';
    $dir           = 'DESC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
    ...
    <form action="cp-includes/get_table.php" id="table_filters" method="post" onsubmit="return update_table();">
        ...
        <div id="topblue" class="fonts small">
			...
			<span id="innerLinks">
				...
				<a href="index.php?l=news_regions">Regions</a>

				<a href="prevent_null.php" onclick="return popup('announcement-add','','1');">Add Post</a>
            ...
            <div class="pad24">
                ...
                <div id="filters_top">
	   			...
	   			<span><?php
                    ...
                    echo $admin->alpha_list('announcements', 'name', 'ppSD_login_announcements');
                ...
                <div class="col50">
                    ...
                    if (!empty($employee['options'][$optname])) {
                        ...
                        $thefilters = array(
                            'title:ppSD_events::',
                            'starts:ppSD_login_announcements:1:1',
                            'ends:ppSD_login_announcements:1:1',
                        );
