...
if ($check != '1') {
    ...
    $table         = 'ppSD_fields';
    $order         = 'ppSD_fields.display_name';
    $dir           = 'ASC';
    $display       = '150';
    $page          = '1';
    $defaults      = array(
    ...
    <form action="cp-includes/get_table.php" id="table_filters" method="post" onsubmit="return update_table();">
        ...
        <div id="topblue" class="fonts small">
			...
			<span id="innerLinks">
				...
				<a href="null.php" onclick="return popup('field-add','','1');">Create Fields</a>
            ...
            <div class="pad24">
                ...
                <div id="filters_top">
                    ...
                    <div id="filters_left">
                        ...
                        <span><?php
                        echo $admin->alpha_list('database_fields', 'display_name', 'ppSD_fields');
                        ?></span>
                ...
                <div class="col50">
                    ...
                    <div class="field">
                        ...
                        <div class="field_entry">
                            ...
                            <input type="text" id="name" value="" name="filter[display_name]" class="filterinputtype"/>
