 ...
 */
$permission = 'promo_code_usage';
$check = $admin->check_permissions($permission, $employee);
if ($check != '1') {
    $admin->show_no_permissions();

} else {
    $table         = 'ppSD_cart_coupon_codes_used';
    $order         = 'ppSD_cart_coupon_codes_used.date';
    $dir           = 'DESC';
    $display       = '50';
    $page          = '1';
    $defaults      = array(
    ...
    <div id="topblue" class="fonts small">
        <div class="holder">
            ...
            <div class="floatleft" id="tb_left">
                ...
                <span><b>Promotional Code Usage</b></span>
        ...
        <div class="pad24">
            ...
            <div class="col50">
                ...
                if (!empty($employee['options'][$optname])) {
                    ...
                    $thefilters = array(
                        'date:ppSD_cart_coupon_codes_used:1:1',
                        'savings:ppSD_cart_coupon_codes_used::',
                    );
            ...
            <div class="col50">
                ...
                <div class="field">
                    ...
                    <div class="field_entry_less">
                        ...
                        <input type="text" value="" name="member_id_name" id="member_id"
                               onkeyup="return autocom('member_id','id','username','ppSD_members','username','members');"
                               style="width:110px;" class="filterinputtype"/>

                        <input type="hidden" name="filter[member_id]" id="member_id_id" value=""/>
