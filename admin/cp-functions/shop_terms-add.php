...
if ($type == 'edit') {
    ...
    $qin            = $db->insert("
		...
		INSERT INTO `ppSD_cart_terms` (`created`$insert_fields2)
...
if ($type == 'add') {
    ...
    $return['show_saved']       = 'Created Terms';

} else {
    $cell                 = $table_format->render_cell($content, '1');
    $return['update_row'] = $cell;
    $return['show_saved'] = 'Updated Terms';
